...
<form name="signup" action="signupServlet.jsp" method="post">
...
<tr>
	<td>User id</td>
	<td><input type="text" name="userid" required autofocus placeholder="Your Username" title="Please enter in more than three letters"/></td>
</tr>
...
<tr>
    <td colspan="2">Registerd User:- <a href="login.jsp">Login</a></td>
</tr>
