...
public class Reviews extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			out.println("<td> <input type=\"text\" name=\"productCatagory\" value= \"Gaming Console\" readonly> </td>");
			out.println("</tr>");
			...
			out.println("<td> <input type=\"text\" name=\"retailerName\" value= \"GAME-SPEED\" readonly> </td>");
			out.println("</tr>");
			
			out.println("<tr>");
			out.println("<td>Retailer City: </td>");
			out.println("<td> <input type=\"text\" name=\"retailerCity\" value= \"Chicago\" readonly> </td>");
			out.println("</tr>");
		
			out.println("<tr>");
			out.println("<td>Retailer Zip: </td>");
			out.println("<td> <input type=\"text\" name=\"retailerZip\" value= \"60616\" readonly> </td>");
			out.println("</tr>");
		
			out.println("<tr>");
			out.println("<td>Retailer State: </td>");
			out.println("<td> <input type=\"text\" name=\"retailerState\" value= \"Illinois\" readonly> </td>");
			out.println("</tr>");
			
			out.println("<tr>");
			out.println("<td>Product OnSale: </td>");
			out.println("<td> <input type=\"text\" name=\"productOnSale\" value= \"Yes\" readonly> </td>");
			out.println("</tr>");
			
			out.println("<tr>");
			out.println("<td>Manufacturer Name: </td>");
			out.println("<td> <input type=\"text\" name=\"manufacturerName\" value= \"LG\" readonly> </td>");
			out.println("</tr>");
			
			out.println("<tr>");
			out.println("<td>Manufacturer Rebate </td>");
			out.println("<td> <input type=\"text\" name=\"manufacturerRebate\" value= \"Yes\" readonly> </td>");
			out.println("</tr>");
